/**
 * Tamil & English Voice Assistant for Fisherman Alert
 * Listens for voice commands and provides audio feedback
 */

import React, { useState, useEffect, useRef } from 'react';
import { Mic, MicOff, MessageSquare, Volume2, X, Info } from 'lucide-react';
...
export default function TamilVoiceAssistant({ 
  ...
  const translations = {
    en: {
      ...
      tapToSpeak: 'Tap to speak commands',
      guide: 'Commands: "Help", "Save Spot", "Distance", "Stop"',
    ...
    ta: {
      ...
      guide: 'கட்டளைகள்: "உதவி", "இடத்தை சேமி", "தூரம் எவ்வளவு", "நிறுத்து"',
      ...
      {/* Mic Button and Help Tip */}
        <div className="flex flex-col items-center gap-1 pointer-events-auto group">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest text-blue-200 drop-shadow-[0_0_8px_rgba(59,130,246,0.8)] px-2 py-0.5 bg-blue-900/40 rounded-full backdrop-blur-sm border border-blue-400/20">
            {isListening ? translations[language].listening : translations[language].tapToSpeak}
          </span>
        </div>
